@extends("layouts.admin.navbar")
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="{{ asset('index.html"><img src="../assets/images/logo.svg') }}" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="{{ asset('index.html"><img src="../assets/images/logo-mini.svg') }}" alt="logo" /></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route("cat.form") }}">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route("prod.addForm") }}">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
