...
@section("content")
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="{{ asset('img/products/n1.jpg') }}" alt="p1">
                <div class="des">
                    <span>adidas</span>
            ...
            <div class="pro">
                <img src="{{ asset('img/products/n2.jpg') }}" alt="p1">
                <div class="des">
                    <span>adidas</span>
                    <h5>Cartoon Astronaut T-Shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="{{ asset('img/products/n3.jpg') }}" alt="p1">
                <div class="des">
                    <span>adidas</span>
                    <h5>Cartoon Astronaut T-Shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="{{ asset('img/products/n4.jpg') }}" alt="p1">
                <div class="des">
                    <span>adidas</span>
                    <h5>Cartoon Astronaut T-Shirt</h5>
                    <div class="star">
