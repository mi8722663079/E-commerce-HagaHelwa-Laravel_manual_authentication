...
gulp.task('replacePath', function () {
    var replacePath1 = gulp.src('./pages/**/*.html', {
        ...
        .pipe(replace('href="{{ url('documentation"', 'href="http://www.bootstrapdash.com/demo/corona-free/jquery/documentation/documentation') }}"'))
        .pipe(replace('href="{{ url('index') }}"', 'href="{{ url('../../index') }}"'))
        .pipe(gulp.dest('.'));
